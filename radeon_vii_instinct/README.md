...
https://www.techpowerup.com/vgabios/229229/amd-radeonprovii-16384-200818

5) Тут два варианта:
5.1) Есть простая видеокарта с GOP и есть куда поставить MI50. Настроить BIOS, если он настроен был ранее, и сразу переходить к п. 6
5.2) Нет возможности одновременно ставить 2 карты (у меня вторая карта была старая и BIOS принудительно уходил в LEGACY режим). Настроить BIOS, но сохранив настройки выключить компьютер, убрать простую карту и поставить MI50, включить компьютер и дождаться когда загрузится Linux. Зайти удаленно в консоль.
